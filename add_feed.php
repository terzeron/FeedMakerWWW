             ...
             $.post(
                 ...
                 function(data, textStatus, jqXHR) {
                     ...
                     if (res["result"] != "0") {
                         ...
                         $("#feedly_link").attr("href", 'https://www.inoreader.com/feed/' + encodeURIComponent('https://terzeron.net/' + sample_feed_name + '.xml'));
                     }
                 }
             );
             reset_handler();
             ...
             $.post(
                 ...
                 function(data, textStatus, jqXHR) {
                     ...
                     if (res["result"] != "0") {
                         ...
                         $("#feedly_link").attr("href", 'https://www.inoreader.com/feed/' + encodeURIComponent('https://terzeron.net/' + feed_name + '.xml'));
                     }
                 }
             );
         };
